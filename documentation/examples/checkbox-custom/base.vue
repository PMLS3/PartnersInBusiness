    ...
    <form class="mx-auto w-full">
      <fieldset class="w-full space-y-6">
        ...
        <div class="grid gap-6 sm:grid-cols-3">
          <FormCheckboxHeadless v-model="value" value="team_member_1">
            <BaseCard
              rounded="sm"
          ...
          <FormCheckboxHeadless v-model="value" value="team_member_2">
            <BaseCard
              rounded="sm"
              class="peer-checked:!border-primary-500 peer-checked:[&_.child]:!text-primary-500 border-2 p-4 opacity-50 peer-checked:opacity-100"
            >
          ...
          <FormCheckboxHeadless v-model="value" value="team_member_3">
            <BaseCard
              rounded="sm"
              class="peer-checked:!border-primary-500 peer-checked:[&_.child]:!text-primary-500 border-2 p-4 opacity-50 peer-checked:opacity-100"
            >
