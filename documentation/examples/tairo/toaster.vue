    ...
    <div class="max-w-md">
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 sm:col-span-6">
          <FormInput v-model="toast.title" label="Title" />
        </div>

        <div class="col-span-12 sm:col-span-6">
          <FormInput v-model="toast.message" label="Message" />
        </div>

        <div class="col-span-12 sm:col-span-6">
          <FormSelect v-model="toast.color" label="Color">
        ...
        <div class="col-span-12 sm:col-span-6">
          <FormSelect v-model="toast.icon" label="Icon">
        ...
        <div class="col-span-12 sm:col-span-6">
          <FormSelect v-model="position" label="Position">
        ...
        <div class="col-span-12">
          <FormCheckbox v-model="toast.closable" label="Closeable toast?" color="primary" />
        </div>
