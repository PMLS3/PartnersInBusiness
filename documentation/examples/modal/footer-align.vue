<template>
  ...
  <!-- Modal component -->
  <Modal :open="isModalStartOpen" size="md" footer-align="start" @close="isModalStartOpen = false">
    <template #header>
      <!-- Header -->
    ...
    <template #footer>
      ...
      <div class="p-4 md:p-6">
        <div class="flex gap-x-2">
          ...
          <BaseButton color="primary" variant="solid" @click="isModalStartOpen = false">
            Accept
          </BaseButton>
        </div>
      </div>
  ...
  <!-- Modal component -->
  <Modal :open="isModalEndOpen" size="md" footer-align="end" @close="isModalEndOpen = false">
    <template #header>
      <!-- Header -->
      <div class="flex w-full items-center justify-between p-4 md:p-6">
        <h3 class="font-heading text-muted-900 text-lg font-medium leading-6 dark:text-white">
    ...
    <template #footer>
      ...
      <div class="p-4 md:p-6">
        <div class="flex gap-x-2">
          ...
          <BaseButton color="primary" variant="solid" @click="isModalEndOpen = false">
            Accept
          </BaseButton>
        </div>
      </div>
    ...
    <template #footer>
      ...
      <div class="p-4 md:p-6">
        <div class="flex gap-x-2">
          ...
          <BaseButton color="primary" variant="solid" @click="isModalCenterOpen = false">
            Accept
          </BaseButton>
        </div>
      </div>
  ...
  >
    ...
    <template #footer>
      ...
      <div class="p-4 md:p-6">
        <div class="flex gap-x-2">
          <BaseButton color="primary" variant="solid" @click="isModalBetweenOpen = false">
            Accept
          </BaseButton>
        </div>
      </div>
