<template>
  <FlexTable>
    <template #header>
      <FlexTableHeading type="shrink">
        <div class="flex items-center">
          <FormCheckbox v-model="selectAll" rounded="md" color="primary" />
        </div>
      </FlexTableHeading>
    ...
    <FlexTableRow v-for="member in team" :key="member.id" rounded="md">
      ...
      <FlexTableCell type="stable" data-content="Actions">
        <BaseButton color="primary" variant="outline" rounded="md" class="scale-90">
          View
        </BaseButton>
      </FlexTableCell>
    </FlexTableRow>
