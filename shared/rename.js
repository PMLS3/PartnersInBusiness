...
const directoryPath = "/Users/peetstander/Projects/o-p-e/components/global/form" // Change this to your directory path
...
const renameFiles = () => {
  fs.readdir(directoryPath, (err, files) => {
    ...
    files.forEach((file) => {
      ...
      if (file.startsWith("Base") && file.endsWith(".vue")) {
        // New file name without 'Demo'
        const newFileName = file.replace(/^Base/, "")
