  ...
  <div class="w-full">
      ...
      <div class="w-full max-w-md">
          ...
          <div class="bg-muted-100 dark:bg-muted-800 p-4 text-center">
            <div class="mx-auto w-full max-w-lg">
              ...
              <div class="flex items-center justify-center">
                <BaseButton color="primary" rounded="md" class="w-32">
                  Link Account
                </BaseButton>
              </div>
            </div>
        ...
        <div class="pb-4 pt-6">
          ...
          <BaseDropdown
            rounded="lg"
            :classes="{
              menuWrapper: 'w-full [&>div]:right-0',
              menu: '!w-full',
            }"
          >
            ...
            <BaseDropdownItem
              v-for="account in accounts.filter(
                (account) => account.id !== request.account?.id
              )"
              :key="account.id"
          ...
          <FormInputHelpText v-if="errors.fields.account" color="danger">
    ...
    <div v-else-if="request.method === 'wire'" class="w-full pb-10">
      <div class="w-full max-w-md">
        ...
        <BaseDropdown
          rounded="lg"
          :classes="{ menuWrapper: 'w-full [&>div]:right-0', menu: '!w-full' }"
        >
          <template #button="{ open }">
            <BaseButton
              v-focus
