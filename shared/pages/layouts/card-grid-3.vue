...
<template>
  <div>
    <ContentWrapper>
      ...
      <template #right>
        <BaseButton rounded="lg" class="w-full sm:w-32"> Settings </BaseButton>
        <BaseButton rounded="lg" color="primary" class="w-full sm:w-32">
            ...
            >
              ...
              >
                ...
                <div class="flex items-center gap-2">
                  <BaseButton rounded="lg" class="w-full"> Tasks </BaseButton>
