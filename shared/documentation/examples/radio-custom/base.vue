    ...
    <form class="mx-auto w-full">
      <fieldset class="w-full space-y-6">
        ...
        <div class="grid gap-6 sm:grid-cols-4">
          <FormRadioHeadless v-model="value" name="radio_custom" value="value_1">
            <BaseCard
              rounded="lg"
          ...
          <FormRadioHeadless v-model="value" name="radio_custom" value="value_2">
            <BaseCard
              rounded="lg"
              class="peer-checked:!border-success-500 peer-checked:!bg-success-500/10 relative border-2 p-5 peer-checked:[&_.child]:!opacity-100"
            >
          ...
          <FormRadioHeadless v-model="value" name="radio_custom" value="value_3">
            <BaseCard
              rounded="lg"
              class="peer-checked:!border-success-500 peer-checked:!bg-success-500/10 relative border-2 p-5 peer-checked:[&_.child]:!opacity-100"
            >
          ...
          <FormRadioHeadless v-model="value" name="radio_custom" value="value_4">
            <BaseCard
              rounded="lg"
              class="peer-checked:!border-success-500 peer-checked:!bg-success-500/10 relative border-2 p-5 peer-checked:[&_.child]:!opacity-100"
            >
