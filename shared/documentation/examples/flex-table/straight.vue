<template>
  <FlexTable>
    <template #header>
      <FlexTableHeading type="shrink">
        <div class="flex items-center">
          <FormCheckbox v-model="selectAll" rounded="none" color="primary" />
        </div>
      </FlexTableHeading>
    ...
    <FlexTableRow v-for="member in team" :key="member.id" rounded="none">
      ...
      <FlexTableCell type="stable" data-content="Expertise" light>
        {{ member.expertise }}
      </FlexTableCell>
      ...
      <FlexTableCell type="stable" data-content="Actions">
        <BaseButton color="primary" variant="outline" rounded="none" class="scale-90">
          View
        </BaseButton>
      </FlexTableCell>
    </FlexTableRow>
