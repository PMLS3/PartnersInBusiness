  ...
  <div class="divide-muted-200 dark:divide-muted-800 space-y-20 py-6">
    ...
    <div class="grid gap-8 md:grid-cols-12">
      ...
      <div class="md:col-span-4">
        ...
        <BaseParagraph size="xs" class="text-muted-500 dark:text-muted-400">
          Tell us how you woould like us to handle your personal data and
          information.
        </BaseParagraph>
      </div>
      <!--Column-->
          ...
          <div class="group">
            ...
            >
              ...
              <div>
                ...
                <BaseText size="sm"> Make your profile visible </BaseText>
              </div>
            </div>
          </div>
          <!--Item-->
          <div class="group">
            ...
            >
              ...
              <div>
                ...
                <BaseText size="sm"> Make your messages private </BaseText>
              </div>
            </div>
          </div>
        </div>
