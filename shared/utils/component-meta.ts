// Define types for the component metadata
...
// Create the metadata function
export default function componentMeta(component: any): ComponentMeta | null {
  // Get the component name
  const name = component?.pascalName
