          ...
          <div class="w-full">
            <Table rounded="sm" :scrollable="false">
              <template #header>
                ...
                <TableHeading uppercase spaced> Collaborator </TableHeading>
                <TableHeading uppercase spaced> Location </TableHeading>
                <TableHeading uppercase spaced> Status </TableHeading>
                <TableHeading uppercase spaced> Completed </TableHeading>
                <TableHeading uppercase spaced class="text-end">
                  Action
                </TableHeading>
              </template>
