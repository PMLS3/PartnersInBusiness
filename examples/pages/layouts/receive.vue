<script setup lang="ts">
  ...
  useHead({
    titleTemplate: (title) =>
      `${title} | Receive money - Step ${currentStepId.value + 1}`,
  })
  ...
  const { handleSubmit, currentStepId, progress, complete, steps, goToStep } =
      ...
      steps: [
        ...
        },
        {
          ...
          meta: {
            ...
            subtitle:
              "Enter the amount that needs to be transferred to your account",
          },
          validate({ data, setFieldError, resetFieldError }) {
            ...
            >
              ...
              >
                <a
                  ...
                  :tabindex="0"
                  :class="[
                    currentStepId === index ? '' : 'xs:hidden',
                    currentStepId > step.id ? 'nui-link' : 'cursor-default',
                  ]"
                  @click.prevent="
                    currentStepId > step.id ? goToStep(step) : () => {}
                  "
                >
                  <span
