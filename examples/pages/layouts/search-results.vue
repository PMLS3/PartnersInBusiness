          ...
          <BaseCard class="p-6">
            ...
            <ul class="space-y-4">
              <li class="flex items-center justify-between">
                ...
                />
                <BaseTag rounded="full" size="sm"> 24 </BaseTag>
              </li>
              <li class="flex items-center justify-between">
                <FormCheckbox
                ...
                />
                <BaseTag rounded="full" size="sm"> 39 </BaseTag>
              </li>
              <li class="flex items-center justify-between">
                <FormCheckbox
                ...
                />
                <BaseTag rounded="full" size="sm"> 17 </BaseTag>
              </li>
            </ul>
          </BaseCard>
          <BaseCard class="p-6">
            ...
            <ul class="space-y-4">
              <li class="flex items-center justify-between">
                ...
                />
                <BaseTag rounded="full" size="sm"> 62 </BaseTag>
              </li>
              <li class="flex items-center justify-between">
                <FormCheckbox
                ...
                />
                <BaseTag rounded="full" size="sm"> 148 </BaseTag>
              </li>
              <li class="flex items-center justify-between">
                <FormCheckbox
                ...
                />
                <BaseTag rounded="full" size="sm"> 23 </BaseTag>
              </li>
              <li class="flex items-center justify-between">
                <FormCheckbox
                ...
                />
                <BaseTag rounded="full" size="sm"> 8 </BaseTag>
              </li>
              <li class="flex items-center justify-between">
                <FormCheckbox
                ...
                />
                <BaseTag rounded="full" size="sm"> 43 </BaseTag>
              </li>
            </ul>
          </BaseCard>
          <BaseCard class="p-6">
            ...
            <ul class="space-y-4">
              <li class="flex items-center justify-between">
                ...
                />
                <BaseTag rounded="full" size="sm"> 12 </BaseTag>
              </li>
              <li class="flex items-center justify-between">
                <FormCheckbox
                ...
                />
                <BaseTag rounded="full" size="sm"> 54 </BaseTag>
              </li>
              <li class="flex items-center justify-between">
                <FormCheckbox
                ...
                />
                <BaseTag rounded="full" size="sm"> 31 </BaseTag>
              </li>
            </ul>
          </BaseCard>
        </div>
