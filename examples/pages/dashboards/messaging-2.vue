      ...
      >
        ...
        <div class="ltablet:pe-0 flex h-full flex-col pe-2 lg:pe-0">
          ...
          <div class="flex h-20 items-center justify-center pe-2">
            <BaseButton rounded="full" color="primary" class="w-full">
          ...
          <div class="relative flex h-full flex-col">
            ...
            <div class="absolute inset-x-0 bottom-4 w-full px-4">
              ...
              >
                ...
                <div>
                  <BaseButton type="submit" color="primary" rounded="lg">
                    <span>Send</span>
                    <Icon
            ...
            <div class="text-center">
              ...
              >
                <div class="flex items-center justify-center gap-2 px-4">
                  <Icon name="ph:timer-duotone" class="text-muted-400 size-4" />
