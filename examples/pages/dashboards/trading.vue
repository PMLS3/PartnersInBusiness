              ...
              <BaseCard rounded="md" class="flex gap-3 p-5">
                ...
                <div class="space-y-1">
                  ...
                  >
                    ...
                    <span class="text-success-500 ps-2 text-sm font-semibold"
                      >(+1.2%)</span
                    >
                  </BaseHeading>
                </div>
              ...
              <BaseCard rounded="md" class="flex gap-3 p-5">
                ...
                <div class="space-y-1">
                  ...
                  >
                    ...
                    <span class="text-danger-500 ps-2 text-sm font-semibold"
                      >(-0.7%)</span
                    >
                  </BaseHeading>
                </div>
              ...
              >
                ...
                <div class="flex items-center gap-2 pt-4">
                  ...
                  <div class="ms-auto flex items-center gap-1">
                    ...
                    >
                      <span>+{{ formatPrice(53.14) }}</span>
                      <span class="text-success-500 ps-2 text-xs font-semibold"
                        >(+1.2%)</span
                      >
                    </BaseHeading>
                    <Icon
                ...
                <div class="flex items-center gap-2 pt-4">
                  ...
                  <div class="ms-auto flex items-center gap-1">
                    ...
                    >
                      <span>-{{ formatPrice(12.37) }}</span>
                      <span class="text-danger-500 ps-2 text-xs font-semibold"
                        >(-0.7%)</span
                      >
                    </BaseHeading>
                    <Icon
              ...
              <div class="space-y-5">
                <div class="flex items-center justify-between">
                  ...
                  <div class="max-w-[140px]">
                    <FormInputNumber v-model="orderShares" placeholder="0.00" />
                  </div>
                </div>
                <div class="flex items-center justify-between">
                  <BaseParagraph size="sm" class="text-muted-400">
