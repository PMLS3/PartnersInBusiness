<script setup lang="ts">
  ...
  useHead({
    titleTemplate: (title) =>
      `${title} | Wizard - Step ${currentStepId.value + 1}`,
  })
    ...
    steps: [
      ...
      },
      {
        ...
        meta: {
          ...
          subtitle:
            "Add useful details to your project. You can edit this later",
        },
      },
      {
        to: "/wizard/step-4",
      ...
      },
      {
        ...
        meta: {
          ...
          subtitle:
            "Choose a set of tools that you'll be using in this project",
        },
      },
      {
        to: "/wizard/step-7",
