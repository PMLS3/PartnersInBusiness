    ...
    <div class="mx-auto flex w-full max-w-sm flex-col gap-3 px-4">
          ...
          <div class="relative">
            ...
            <div v-else class="flex items-center gap-3">
              ...
              <div class="me-3 ms-auto">
                <BaseButtonIcon small rounded="full" @click="dismissCustomer">
      ...
      <BaseCard rounded="lg" class="p-6">
        ...
        <div class="flex w-full justify-center gap-3">
          <FormRadioHeadless v-model="budget" name="budget" value="< 5K">
            <BaseButtonAction
              rounded="lg"
          ...
          <FormRadioHeadless v-model="budget" name="budget" value="< 30K">
            <BaseButtonAction
              rounded="lg"
              class="peer-checked:!bg-primary-500 peer-checked:!border-primary-500 peer-checked:shadow-primary-500/20 peer-checked:!text-white peer-checked:shadow-xl"
            >
          ...
          <FormRadioHeadless v-model="budget" name="budget" value="< 100K">
            <BaseButtonAction
              rounded="lg"
              class="peer-checked:!bg-primary-500 peer-checked:!border-primary-500 peer-checked:shadow-primary-500/20 peer-checked:!text-white peer-checked:shadow-xl"
            >
